...
export type { RateLimitConfig } from './rate-limit-config.interface';
export type { RegisteredController } from './registered-controller.interface';
export type {
  BodyLimitConfig,
  CorsConfig,
  SecurityConfig,
...
export type { WindowEntry } from './window-entry.interface';
export type { ValidationDetail } from './error-validation-detail.interface';
