export const MESSAGES = {
  ...
  RUN_ONCE_PAST_DATE: (date: string) =>
    `@RunOnce date "${date}" is in the past — the job will never fire`,
  RUN_ONCE_REGISTERED: (name: string, date: string) =>
    `Registered run-once job "${name}" — fires at ${date}`,
