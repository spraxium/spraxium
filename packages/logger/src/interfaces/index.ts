export type { BuiltInLogLevel, LogLevel } from './log-level.type';
export type { LogColor, LogColorInput } from './log-color.type';
export type { LogFn } from './log-fn.type';
...
export type { PartialEmbed } from './partial-embed.interface';
